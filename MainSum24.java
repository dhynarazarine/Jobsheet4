...
public class MainSum24 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < jumlahPerusahaan; i++) {
            System.out.println("Total keuntungan perusahaan " + (i + 1) + " selama " + perusahaan[i].elemen
                    + " bulan adalah = " + perusahaan[i].totalBF(perusahaan[i].keuntungan));
        }
        ...
        for (int i = 0; i < jumlahPerusahaan; i++) {
            System.out.println(
                    "Total keuntungan perusahaan " + (i + 1) + " selama " + perusahaan[i].elemen + " bulan adalah = "
